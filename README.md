...
* **DoublePulsar_structure_exec.cpp** - This program sends 5 SMB packets.  1 SMB negotiation, 1 session setup, 1 tree connect, 1 Doublepulsar Trans2 SESSION_SETUP Ping packet and 1 Doublepulsar Trans2 SESSION_SETUP Execution packet.
